...
class select2: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    
    @IBOutlet weak var selectPhoto2: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        selectPhoto2.image = selectedImage
        
        //save the select to the array
        //imageArray[1] = selectPhoto2.image!
