...
class selectImage:  UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    @IBOutlet weak var selectPhoto1: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        selectPhoto1.image = selectedImage
        
        //save the select to the array
        //imageArray[0] = selectPhoto1.image!
