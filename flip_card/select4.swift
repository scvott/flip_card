...
class select4: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    @IBOutlet weak var selectPhoto4: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        selectPhoto4.image = selectedImage
        
        //save the select to the array
        //imageArray[3] = selectPhoto4.image!
